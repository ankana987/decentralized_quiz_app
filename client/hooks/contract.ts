...
export const CONTRACT_ADDRESS =
  "CDHOYQNYSENLSDSSI2H7DCZ4SMARPEB4NEVJB7YSSPZLBV6IXBJXNUMD";
...
// ============================================================
// Decentralized Quiz App — Contract Methods
// ============================================================

/**
 * Create a new quiz.
 * Calls: create_quiz(id: u32, question: Symbol, answer: Symbol)
 */
export async function createQuiz(
  ...
  return callContract(
    "create_quiz",
    [toScValU32(id), toScValSymbol(question), toScValSymbol(answer)],
    caller,
    true
  );
}
 ...
 * Calls: submit_answer(user: Address, id: u32, answer: Symbol)
 */
export async function submitAnswer(
  ...
  return callContract(
    "submit_answer",
    [toScValAddress(user), toScValU32(id), toScValSymbol(answer)],
    caller,
    true
  );
}
...
/**
 * Get a user's score for a quiz (read-only).
 * Calls: get_score(user: Address, id: u32) -> u32
 */
export async function getScore(
  ...
  return readContract(
    "get_score",
    [toScValAddress(user), toScValU32(id)],
    caller
  );
}
